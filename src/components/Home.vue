<template>
  <section>
    ...
    <div class="row at-row flex-center flex-middle">
      ...
      <div class="col-lg-6">
        <a href="https://github.com/MicrosoftDocs/mslearn-aks-workshop-ratings-web" target="_blank"><at-button icon="icon-github" class="mid-btn" type="info" hollow>Clone our repo</at-button></a>
      </div>
      <div class="col-lg-3">
      </div>
    </div>
